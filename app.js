...
console.log("Exercise 1: " + numsTimesTwo.join(", "));
...
console.log("Exercise 2 First Ingredient: " + firstIngredient);
console.log("Exercise 2 Second Ingredient: " + secondIngredient);
...
console.log("Exercise 5: ", anotherCar);
...
userProfile[propertyName] = "Andmryan"

console.log("Exercise 6: ", userProfile);

// ! Exercise 7:
console.log("Exercise 7: Import/Export JS");
...
let isYum = pizza === "tasty" ? "Yum!" : "Yuck!";

console.log("Exercise 9: " + isYum);
...
const localLangConfig = "PT"; // Change to 'es', 'fr', etc., or leave it `null`.
...
// All finished! A few minor hiccups, but I like this. I think. (For now)